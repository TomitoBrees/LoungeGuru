...
>
    <div class="relative w-64 mx-auto">
        ...
        <Combobox.Input
                ...
                class="w-64 px-12 py-2 border-2 border-primary rounded-md text-center text-base placeholder:text-center placeholder:text-base-content focus:outline-none focus:ring-2 focus:ring-primary transition"
